      ...
      <article className="privacy-card">
        ...
        <div className="privacy-sections">
          ...
          <section>
            ...
            <div>
              <h2>기기에 저장되는 설정</h2>
              <p>옥타브 버튼, 건반 수, 키 매핑, 표시 방식, 음색, 음량과 마이크 감도 등의 설정, 마지막 MML 프로젝트·편집 기록과 사용자가 추가한 사운드팩은 브라우저의 기기 저장 공간에만 보관됩니다. 이 정보는 서버로 전송되지 않으며, 설정 초기화, 사운드팩 삭제 또는 브라우저의 사이트 데이터 삭제 기능으로 지울 수 있습니다.</p>
            </div>
          </section>
