...
const MML_ITEMS = [
  ...
  ["MML 텍스트 편집", "코드를 직접 붙여넣거나 고칩니다. 일부 코드를 드래그한 뒤 오른쪽 클릭하면 선택한 음표의 길이를 한꺼번에 바꿀 수 있습니다."],
        ...
        <section className="help-section help-settings-section" id="settings">
          ...
          <div className="help-settings-layout">
            ...
            <div className="help-settings-list">
              ...
              <div><span>04</span><h3>불어서 연주</h3><p>마이크 음높이를 분석하지 않고 바람 세기만 이용해 연주 음량을 조절합니다.</p></div>
              <div><span>05</span><h3>키 매핑</h3><p>왼쪽·오른쪽 건반, 옥타브 F1–F8, 반음·완전5도 조옮김과 초기화 키를 각각 바꿉니다. 매핑 문자 표시를 켜면 현재 키가 건반과 조작 버튼 안에 보입니다.</p></div>
            </div>
          </div>
        </section>
